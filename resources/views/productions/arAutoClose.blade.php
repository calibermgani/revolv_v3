                    ...
                    <div class="col-md-6">
                        <div class="row" style="justify-content: flex-end;margin-right:1.4rem">
                            ...
                            <div class="d-flex align-items-center" id="export_div">
                                <a class="btn btn-primary-export text-white ml-2" href="javascript:void(0);"
                                    id='assign_export' style="font-size:13px"> <svg xmlns="http://www.w3.org/2000/svg"
                                        width="18" height="16" fill="currentColor" class="bi bi-box-arrow-up"
                                        viewBox="0 0 16 16">
                ...
                <div class="card-body py-0 px-7" id="filter_section" style="display:none">
                    ...
                    @if (count($projectColSearchFields) > 0)
                        ...
                        @foreach ($projectColSearchFields as $key => $data)
                            ...
                            {!! Form::open([
                                'url' =>
                                    url('projects_auto_close/' . $clientName . '/' . $subProjectName) .
                                    '?parent=' .
                                    request()->parent .
                                    '&child=' .
                                    request()->child,
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#filter_clear', function(e) {
                window.location.href = baseUrl + 'projects_auto_close/' + clientName + '/' +
                    subProjectName +
                    "?parent=" +
                    getUrlVars()[
                        "parent"] +
