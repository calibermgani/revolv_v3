                ...
                <div class="row mr-0 ml-0">
                    <div class="col-md-3">
                        <div class="form-group row row_mar_bm">
                            <div class="col-md-10">
                                <input type="datetime-local" id="startDateTime" name="startDateTime" class="form-control" value="{{ old('startTime', now()->format('Y-m-d\TH:i')) }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group row row_mar_bm">
                            <div class="col-md-10">
                                <input type="datetime-local" id="endDateTime" name="endDateTime" class="form-control" value="{{ old('endTime', now()->format('Y-m-d\TH:i')) }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
