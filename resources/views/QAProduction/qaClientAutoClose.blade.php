            ...
            <div class="wizard-nav">
                <div class="wizard-steps">
                    ...
                    @if (
                        ...
                        strpos($empDesignation, 'Group Coordinator') !== false || strpos($empDesignation, 'Subject Matter Expert') !== false || strpos($empDesignation, 'Group Co-ordinator - Quality') !== false || strpos($empDesignation, 'Group Co-ordinator - AR') !== false)
                ...
                <div class="card-body py-0 px-7">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="ml-3">
                         ...
                         <div>
                            {{ $autoCloseProjectDetails->appends(request()->all())->links() }}
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function() {
            ...
            var excludedFields = ['QA_rework_comments', 'chart_status','coder_rework_status','coder_rework_reason','QA_status_code','QA_sub_status_code','qa_hold_reason','	ce_hold_reason'];
                ...
                $(document).on('click', '#assign_export', function(e) {
                    ...
                    var recordStatusVal = "Auto_Close";
