...
Route::group(['prefix' => 'projects'], function() {
    ...
    Route::get('project_daterange_wise_non_ar_aims_production','App\Http\Controllers\ProjectController@projectDateRangeWiseNonArAimsProduction');
    Route::get('date-range-non-ar-aims-production-results',  'App\Http\Controllers\ProjectController@getNonArDateWiseRangeResults');
