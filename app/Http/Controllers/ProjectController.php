...
class ProjectController extends Controller
{
    ...
    public function projectWorkMail()
    {
        try {
            ...
            $mailHeader = "Resolv Utilization Report for 2024-11-13 - Trail";
            $yesterDayStartDate = "2024-11-13 17:00:00";
            $yesterDayEndDate = "2024-11-14 09:00:00";
                        ...
                        if (class_exists($modelClass)) {
                           ...
                           // Log::error('Total Users: ' . print_r($totalARDetails['totalArList'], true));
                            ...
                            foreach($totalARDetails['totalArList'] as $key => $arList){
                               $yesterday5PM = "2024-11-13 17:00:00"; //Carbon::yesterday()->setTime(17, 0); // Yesterday at 5:00 PM
                                $tomorrow9AM = "2024-11-14 09:00:00"; //Carbon::tomorrow()->setTime(9, 0); 
