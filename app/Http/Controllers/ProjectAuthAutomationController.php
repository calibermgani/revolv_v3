...
class ProjectAuthAutomationController extends Controller
{
    ...
    public function orthopaedicSpineCenterOfTheRockiesArBkp(Request $request)
    {
        try {
            $attributes = [
    ...
    public function orthopaedicSpineCenterOfTheRockiesArDuplicatesBkp(Request $request)
    {
        try {
 ...
 public function dkmgArBehavioralMentalHealthDuplicates(Request $request)
    ...
    public function pbhgPreAuthVerification(Request $request)  {
        try {
            ...
            $duplicateRecordExisting = PbhgPreAuthVerification::where($attributes)->exists();

            if (!$duplicateRecordExisting) {
                // FIRST TIME INSERT
                PbhgPreAuthVerification::insert([
                    'organization' => isset($request->organization) && $request->organization != "NULL" ? $request->organization : NULL,
                    'patient_name' => isset($request->patient_name) && $request->patient_name != "NULL" ? $request->patient_name : NULL,
                    'client_id' => isset($request->client_id) && $request->client_id != "NULL" ? $request->client_id : NULL,
                    'admit_date' => isset($request->admit_date) && $request->admit_date != "NULL" ? $request->admit_date : NULL,
                ...
                $duplicateRecords = PbhgPreAuthVerification::where($attributes)->where('chart_status', 'CE_Assigned')->get();
    ...
    public function pbhgPreAuthVerificationDuplicates(Request $request)  {
        try {
                PbhgPreAuthVerificationDuplicates::insert([
                    'organization' => isset($request->organization) && $request->organization != "NULL" ? $request->organization : NULL,
                    'patient_name' => isset($request->patient_name) && $request->patient_name != "NULL" ? $request->patient_name : NULL,
                    'client_id' => isset($request->client_id) && $request->client_id != "NULL" ? $request->client_id : NULL,
                    'admit_date' => isset($request->admit_date) && $request->admit_date != "NULL" ? $request->admit_date : NULL,
        ...
        public function orthopaedicSpineCenterOfTheRockiesAr(Request $request)
    {
        try {
            $attributes = [
                 'ticket_number' => isset($request->ticket_number) && $request->ticket_number != "NULL" ? $request->ticket_number : NULL,
                 'total_pv_bal' => isset($request->total_pv_bal) && $request->total_pv_bal != "NULL" ? $request->total_pv_bal : NULL,
                 'dos' => isset($request->dos) && $request->dos != "NULL" ? $request->dos : NULL,
             ];         
            ...
            if (!$duplicateRecordExisting) {
                   OscotrAr::insert([
                        ...
                        'facility' => isset($request->facility) && $request->facility != "NULL" ? $request->facility : NULL,
                        'doctor' => isset($request->doctor) && $request->doctor != "NULL" ? $request->doctor : NULL,
                        'patient_internal_id' => isset($request->patient_internal_id) && $request->patient_internal_id != "NULL" ? $request->patient_internal_id : NULL,
                        'patient_name' => isset($request->patient_name) && $request->patient_name != "NULL" ? $request->patient_name : NULL,
                        'dos' => isset($request->dos) && $request->dos != "NULL" ? $request->dos : NULL,
                        'ticket_number' => isset($request->ticket_number) && $request->ticket_number != "NULL" ? $request->ticket_number : NULL,
                        'total_chrg' => isset($request->total_chrg) && $request->total_chrg != "NULL" ? $request->total_chrg : NULL,
                        ...
                        'current_insur_group' => isset($request->current_insur_group) && $request->current_insur_group != "NULL" ? $request->current_insur_group : NULL,
                        'total_pmnt' => isset($request->total_pmnt) && $request->total_pmnt != "NULL" ? $request->total_pmnt : NULL,
                        'total_adj' => isset($request->total_adj) && $request->total_adj != "NULL" ? $request->total_adj : NULL,
                        'total_pv_bal' => isset($request->total_pv_bal) && $request->total_pv_bal != "NULL" ? $request->total_pv_bal : NULL,
                        'insur_alloc' => isset($request->insur_alloc) && $request->insur_alloc != "NULL" ? $request->insur_alloc : NULL,
                        'insur_pmnt' => isset($request->insur_pmnt) && $request->insur_pmnt != "NULL" ? $request->insur_pmnt : NULL,
                        'insur_adj' => isset($request->insur_adj) && $request->insur_adj != "NULL" ? $request->insur_adj : NULL,
                        'insur_pv_bal' => isset($request->insur_pv_bal) && $request->insur_pv_bal != "NULL" ? $request->insur_pv_bal : NULL,
                        'patient_alloc' => isset($request->patient_alloc) && $request->patient_alloc != "NULL" ? $request->patient_alloc : NULL,
                        'patient_pmnt' => isset($request->patient_pmnt) && $request->patient_pmnt != "NULL" ? $request->patient_pmnt : NULL,
                        'patient_adj' => isset($request->patient_adj) && $request->patient_adj != "NULL" ? $request->patient_adj : NULL,
                        'patient_pv_bal' => isset($request->patient_pv_bal) && $request->patient_pv_bal != "NULL" ? $request->patient_pv_bal : NULL,
                        'visit_description' => isset($request->visit_description) && $request->visit_description != "NULL" ? $request->visit_description : NULL,
                        'visit_owner' => isset($request->visit_owner) && $request->visit_owner != "NULL" ? $request->visit_owner : NULL,
                        'invoke_date' => date('Y-m-d'),
                        'CE_emp_id' => isset($request->CE_emp_id) && $request->CE_emp_id != '-' && $request->CE_emp_id != "NULL" ? $request->CE_emp_id : NULL,
    ...
    public function tqhsAdjudication(Request $request) {
        try {
            $attributes = [
                'invoice_number' => isset($request->invoice_number) && $request->invoice_number != "NULL" ? $request->invoice_number : NULL,
                'invoke_date' => carbon::now()->format('Y-m-d')
            ...
            $duplicateRecordExisting  =  TqhsAdjudication::where($attributes)->exists();
            if (!$duplicateRecordExisting) {
                TqhsAdjudication::insert([
                    'priority' => isset($request->priority) && $request->priority != "NULL" ? $request->priority : NULL,  
                    'fup_score' => isset($request->fup_score) && $request->fup_score != "NULL" ? $request->fup_score : NULL,  
                    'invoice_number' => isset($request->invoice_number) && $request->invoice_number != "NULL" ? $request->invoice_number : NULL,  
                    'patient' => isset($request->patient) && $request->patient != "NULL" ? $request->patient : NULL, 
                    'dos' => isset($request->dos) && $request->dos != "NULL" ? $request->dos : NULL, 
                    'over_ninety' => isset($request->over_ninety) && $request->over_ninety != "NULL" ? $request->over_ninety : NULL, 
                    'created' => isset($request->created) && $request->created != "NULL" ? $request->created : NULL, 
                    'sts' => isset($request->sts) && $request->sts != "NULL" ? $request->sts : NULL, 
                    'account_id' => isset($request->account_id) && $request->account_id != "NULL" ? $request->account_id : NULL, 
                    'account' => isset($request->account) && $request->account != "NULL" ? $request->account : NULL, 
                    ...
                    'timely_filing_deadline_date' => isset($request->timely_filing_deadline_date) && $request->timely_filing_deadline_date != "NULL" ? $request->timely_filing_deadline_date : NULL,
                    'days_until_timely_filing_deadline' => isset($request->days_until_timely_filing_deadline) && $request->days_until_timely_filing_deadline != "NULL" ? $request->days_until_timely_filing_deadline : NULL,
                    'id_one' => isset($request->id_one) && $request->id_one != "NULL" ? $request->id_one : NULL,
                    'bill_area' => isset($request->bill_area) && $request->bill_area != "NULL" ? $request->bill_area : NULL,
                    'department' => isset($request->department) && $request->department != "NULL" ? $request->department : NULL,
                    'pos' => isset($request->pos) && $request->pos != "NULL" ? $request->pos : NULL,
                    'bill_area_name' => isset($request->bill_area_name) && $request->bill_area_name != "NULL" ? $request->bill_area_name : NULL,
                    'cross_over_flag' => isset($request->cross_over_flag) && $request->cross_over_flag != "NULL" ? $request->cross_over_flag : NULL,
                    'id_two' => isset($request->id_two) && $request->id_two != "NULL" ? $request->id_two : NULL,
                    'last_activity' => isset($request->last_activity) && $request->last_activity != "NULL" ? $request->last_activity : NULL,
                    'reason_codes' => isset($request->reason_codes) && $request->reason_codes != "NULL" ? $request->reason_codes : NULL,
                    'procedure_code' => isset($request->procedure_code) && $request->procedure_code != "NULL" ? $request->procedure_code : NULL,
                    'open_hb_denials' => isset($request->open_hb_denials) && $request->open_hb_denials != "NULL" ? $request->open_hb_denials : NULL,
                ...
                $duplicateRecords = TqhsAdjudication::where($attributes)->where('chart_status',"CE_Assigned")->get();
                if ($duplicateRecords->isNotEmpty()) {
                    foreach ($duplicateRecords as $duplicateRecord) {
                        $duplicateRecord->update([
                        'priority' => isset($request->priority) && $request->priority != "NULL" ? $request->priority : NULL,  
    ...
    public function TqhsAdjudicationDuplicates(Request $request){
        try {
            TqhsAdjudicationDuplicates::insert([
                    'priority' => isset($request->priority) && $request->priority != "NULL" ? $request->priority : NULL,  
                    'fup_score' => isset($request->fup_score) && $request->fup_score != "NULL" ? $request->fup_score : NULL,  
                    'invoice_number' => isset($request->invoice_number) && $request->invoice_number != "NULL" ? $request->invoice_number : NULL,  
                    'patient' => isset($request->patient) && $request->patient != "NULL" ? $request->patient : NULL, 
      ...
      public function tqhsCodingToBilling(Request $request) {
        try {
            $attributes = [
                'invoice_number' => isset($request->invoice_number) && $request->invoice_number != "NULL" ? $request->invoice_number : NULL,
                'invoke_date' => carbon::now()->format('Y-m-d')
            ...
            $duplicateRecordExisting  =  TqhsCodingToBilling::where($attributes)->exists();
            if (!$duplicateRecordExisting) {
                TqhsCodingToBilling::insert([
                    'priority' => isset($request->priority) && $request->priority != "NULL" ? $request->priority : NULL,  
                    'fup_score' => isset($request->fup_score) && $request->fup_score != "NULL" ? $request->fup_score : NULL,  
                    'invoice_number' => isset($request->invoice_number) && $request->invoice_number != "NULL" ? $request->invoice_number : NULL,  
                    'patient' => isset($request->patient) && $request->patient != "NULL" ? $request->patient : NULL, 
                ...
                $duplicateRecords = TqhsCodingToBilling::where($attributes)->where('chart_status',"CE_Assigned")->get();
                if ($duplicateRecords->isNotEmpty()) {
                    foreach ($duplicateRecords as $duplicateRecord) {
                        $duplicateRecord->update([
                        'priority' => isset($request->priority) && $request->priority != "NULL" ? $request->priority : NULL,  
    ...
    public function tqhsCodingToBillingDuplicates(Request $request){
        try {
            TqhsCodingToBillingDuplicates::insert([
                    'priority' => isset($request->priority) && $request->priority != "NULL" ? $request->priority : NULL,  
                    'fup_score' => isset($request->fup_score) && $request->fup_score != "NULL" ? $request->fup_score : NULL,  
                    'invoice_number' => isset($request->invoice_number) && $request->invoice_number != "NULL" ? $request->invoice_number : NULL,  
                    'patient' => isset($request->patient) && $request->patient != "NULL" ? $request->patient : NULL, 
    ...
    public function helixonaARDuplicates(Request $request){
     ...
     public function seleverstovMedicalPC(Request $request) {
        try {
            $attributes = [
                'claim_no' => isset($request->claim_no) && $request->claim_no != "NULL" ? $request->claim_no : NULL,
                'dos' => isset($request->dos) && $request->dos != "NULL" ? $request->dos : NULL,
                'claim_status_code_description' => isset($request->claim_status_code_description) && $request->claim_status_code_description != "NULL" ? $request->claim_status_code_description : NULL,
                'claim_amount' => isset($request->claim_amount) && $request->claim_amount != "NULL" ? $request->claim_amount : NULL
             ];        
 
            $duplicateRecordExisting  =  SmpSeleverstovFollowUp::where($attributes)->exists();
            if (!$duplicateRecordExisting) {
                SmpSeleverstovFollowUp::insert([
                    'claim_no' => isset($request->claim_no) && $request->claim_no != "NULL" ? $request->claim_no : NULL,
                ...
                $duplicateRecords  =  SmpSeleverstovFollowUp::where($attributes)->where('chart_status',"CE_Assigned")->get();
                if ($duplicateRecords->isNotEmpty()) {
                    foreach ($duplicateRecords as $duplicateRecord) {
                        $duplicateRecord->update([
                            'claim_no' => isset($request->claim_no) && $request->claim_no != "NULL" ? $request->claim_no : NULL,
    ...
    public function seleverstovMedicalPCDuplicates(Request $request){
        try {
            SmpSeleverstovFollowUpDuplicates::insert([
                'claim_no' => isset($request->claim_no) && $request->claim_no != "NULL" ? $request->claim_no : NULL,
                'facility_name'=> isset($request->facility_name) && $request->facility_name != "NULL" ? $request->facility_name : NULL,
                'patient_name' => isset($request->patient_name) && $request->patient_name != "NULL" ? $request->patient_name : NULL,
                'dos' => isset($request->dos) && $request->dos != "NULL" ? $request->dos : NULL,
    ...
    public function phhePhoenixHeartFollowUp(Request $request) {
        try {
            $attributes = [
                'claim_id' => isset($request->claim_id) && $request->claim_id != "NULL" ? $request->claim_id : NULL,                
                'payer' => isset($request->payer) && $request->payer != "NULL" ? $request->payer : NULL,
            ...
            if (!$duplicateRecordExisting) {
                PhhePhoenixHeartFollowUp::insert([
                    'claim_id' => isset($request->claim_id) && $request->claim_id != "NULL" ? $request->claim_id : NULL,
                    'payer'=> isset($request->payer) && $request->payer != "NULL" ? $request->payer : NULL,
                ...
                $duplicateRecords  =  PhhePhoenixHeartFollowUp::where($attributes)->where('chart_status',"CE_Assigned")->get();
                if ($duplicateRecords->isNotEmpty()) {
                    foreach ($duplicateRecords as $duplicateRecord) {
                        $duplicateRecord->update([
                           'claim_id' => isset($request->claim_id) && $request->claim_id != "NULL" ? $request->claim_id : NULL,
        ...
        try {
            ...
            if (!$duplicateRecordExisting) {
                EshExcelsiorFollowUp::insert([
                    ...
                    'medical_service' => (isset($request->medical_service) && $request->medical_service != "NULL") ? $request->medical_service : NULL,
                    'invoke_date' => date('Y-m-d'),
                    'CE_emp_id' => isset($request->CE_emp_id) && $request->CE_emp_id != '-' && $request->CE_emp_id != "NULL" ? $request->CE_emp_id : NULL,
                    'QA_emp_id' => isset($request->QA_emp_id) && $request->QA_emp_id != '-' && $request->QA_emp_id != "NULL" ? $request->QA_emp_id : NULL,
                    'chart_status' => "CE_Assigned"
    ...
    public function gmhcGmhcFollowUp(Request $request) {
        try {
            $attributes = [
                'claim_id' => isset($request->claim_id) && $request->claim_id != "NULL" ? $request->claim_id : NULL,
                'payer'=> isset($request->payer) && $request->payer != "NULL" ? $request->payer : NULL,
            ...
            $duplicateRecordExisting  =  GmhcGmhcFollowUp::where($attributes)->exists();
            if (!$duplicateRecordExisting) {
                GmhcGmhcFollowUp::insert([
                    'claim_id' => isset($request->claim_id) && $request->claim_id != "NULL" ? $request->claim_id : NULL,
                    'payer'=> isset($request->payer) && $request->payer != "NULL" ? $request->payer : NULL,
                    'insurance_package' => isset($request->insurance_package) && $request->insurance_package != "NULL" ? $request->insurance_package : NULL,
                    'outstanding_amount' => isset($request->outstanding_amount) && $request->outstanding_amount != "NULL" ? $request->outstanding_amount : NULL,
                ...
                $duplicateRecords  =  GmhcGmhcFollowUp::where($attributes)->where('chart_status',"CE_Assigned")->get();
                if ($duplicateRecords->isNotEmpty()) {
                    foreach ($duplicateRecords as $duplicateRecord) {
                        $duplicateRecord->update([
                            'claim_id' => isset($request->claim_id) && $request->claim_id != "NULL" ? $request->claim_id : NULL,
    ...
    public function gmhcGmhcFollowUpDuplicates(Request $request){
        try {
            GmhcGmhcFollowUpDuplicates::insert([
                    'claim_id' => isset($request->claim_id) && $request->claim_id != "NULL" ? $request->claim_id : NULL,
                    'payer'=> isset($request->payer) && $request->payer != "NULL" ? $request->payer : NULL,
                    'insurance_package' => isset($request->insurance_package) && $request->insurance_package != "NULL" ? $request->insurance_package : NULL,
                    'outstanding_amount' => isset($request->outstanding_amount) && $request->outstanding_amount != "NULL" ? $request->outstanding_amount : NULL,
