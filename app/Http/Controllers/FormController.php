                ...
                $tableExists = DB::select("SHOW TABLES LIKE '$tableName'");
                    if (empty($tableExists)) {
                        ...
                        $createTableSQL .= ", invoke_date DATE NULL,
                                            ...
                                            chart_status ENUM('CE_Assigned','CE_Inprocess','CE_Pending','CE_Completed','CE_Clarification','CE_Hold','AR_non_workable','QA_Assigned','QA_Inprocess','QA_Pending','QA_Completed','QA_Clarification','QA_Hold','Revoke','Rebuttal') DEFAULT 'CE_Assigned',
