    ...
    @if (isset($mailBody) && count($mailBody) > 0)
        ...
        @php
            ...
            $noActivityMailBody = $sortedMailBody
                ...
                ->values();
                /*
                * Fetch all Billable FTE and SLA Target values in one query.
                */
                $projectTargetList = DB::table('aims_project_du_targets')
                    ->select(
                        'client_id',
                        'subproject_id',
                        'billable_fte',
                    ...
                    ->whereIn(
                        'subproject_id',
                        array_values(array_unique($subProjectIds))
                    )
                    ->get()
                    ->keyBy(function ($target) {
                        return $target->client_id . '_' . $target->subproject_id;
                    });
        ...
        @foreach ($reportTables as $reportTable)
            ...
            <h3 style="
                ...
                white-space: nowrap;
            ">
                {{ $reportTable['heading'] }} ({{ $reportTable['rows']->count() }})
            </h3>
            ...
            <table class="table"
                   ...
                   cellpadding="0"
                   cellspacing="0"
                   style="border-collapse: collapse; width: auto; min-width: 100%;">
                ...
                @if ($reportTable['rows']->count() > 0)
                    ...
                    @foreach ($reportTable['rows'] as $mKey => $data)
                        ...
                        @php
                            ...
                            //     )
                            //     ->first();
                            $targetKey = $rowProjectId . '_' . $rowSubProjectId;

                            $billableFTE = $projectTargetList->get($targetKey);
                        @endphp
                        ...
                        <tr>
                            ...
                            ">
                                ...
                                {{ $billableFTE ? $billableFTE->billable_fte : '--' }}
                            </td>
                            ...
                            ">
                                ...
                                {{ $billableFTE ? $billableFTE->actual_target : '--' }}
                            </td>
