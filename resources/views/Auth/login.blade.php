...
@section('content')
    ...
    <div class="form-group ml-8 mr-8 mt-6">
        <label for="exampleInputEmail" class="login-username">{{ __('Username') }}</label>
        <div class="input-group">
            <input id="emp_id" type="text" 
                class="form-control login-input h-auto py-5 px-6 @error('emp_id') is-invalid @enderror" name="emp_id"
                value="{{ old('emp_id') }}" required autocomplete="off" autofocus>
            @error('email')
    ...
    <div class="form-group ml-8 mr-8">
        ...
        <div class="input-group">
            <input id="password" type="password" 
                class="form-control login-input h-auto py-5 px-6 @error('password') is-invalid @enderror" name="password"
    ...
    <div class="g-recaptcha ml-8" data-type="image" data-sitekey="{{ config('services.recaptcha.site_key') }}"></div>
