                            ...
                            @endphp
                                ...
                                @endphp
                                    <tr>
                                        ...
                                        <td>
                                            @if(is_array($prjBillableFTE) && isset($prjBillableFTE['prjBillableCount'], $prjBillableFTE['projectInternalTarget']))
                                                {{ round((float)$prjBillableFTE['prjBillableCount'] * (float)$prjBillableFTE['projectInternalTarget']) }}
                                            @else
