...
@push('view.scripts')
    ...
    <script>
        $(document).ready(function() {
                    ...
                    message: 'Processing started...',
                         ...
                         if(isSelectAllChecked == true) {
                                    swal.fire({
                                        ...
                                        if (result.value == true) {
                                          clientColumnList(project_id, sub_project_id, work_date, client_status, user, checkedValues);
                                        } else {}
                                    });
                        } else {
                             clientColumnList(project_id, sub_project_id, work_date, client_status, user, checkedValues);
            ...
            function clientColumnList(project_id, sub_project_id, work_date, client_status, user, checkedValues) {
                $.ajax({
                    type: "POST",
