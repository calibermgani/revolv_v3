...
var KTBootstrapDatetimepicker = function () {
    ...
    var demos = function () {
        ...
        $('.date_picker_jquery').datetimepicker({
            format: "yyyy/mm/dd",
            todayHighlight: true,
            autoclose: true,
            startView: 2,
        ...
        $('#kt_datetimepicker_7,#interviewInTime,#interviewOutTime,#start_time,#end_time').datetimepicker({
            format: "hh:ii",
            showMeridian: true,
            todayHighlight: true,
            autoclose: true,
        ...
        $(".date_picker_production").datepicker({
            format: "mm-dd-yyyy",
            todayHighlight: true,
            autoclose: true,
            startDate: '-1d',
