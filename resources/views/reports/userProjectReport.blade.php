              ...
              <div class="card-toolbar d-inline float-right mt-0">
                <div class="card-toolbar d-inline float-right mt-3">
                    <div class="outside" href="javascript:void(0);" id="export_data">
                        <span data-dismiss="modal" class="btn btn-secondary--icon p-2 float-right mr-3 mb-3"
                                            ...
                                            <td>{{   $subProjectName }}</td>
                                                @foreach ($dates as $date)
                                                    @php
                                                        ...
                                                        ->count();
                                                    @endphp
                                                    <td style="background-color: #ebedf3;text-align: center">{{$resolvCount}}</td> {{-- Resolv Count --}}
                                                    <td style="text-align: center">{{ $aimsCount }}</td> {{-- AIMS Count --}}
                                                @endforeach                               
                                        </tr>
                                    @endif
                                @endforeach
