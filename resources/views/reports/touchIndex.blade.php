        ...
        <div class="card-header border-0 px-4">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <span class="project_header" style="margin-left: 4px !important;">Touch Report List</span>
                </div>
            </div>
        </div>
...
<!-- Modal content-->
<div class="modal fade" id="reportModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" aria-hidden="true">
    ...
    <script>
        $(document).ready(function() {
            ...
            function getColumnsheaders() {
                ...
                $.ajax({
                    type: "POST",
                    url: baseUrl + 'report/touch_report_client_assigned_tab',
                    data: {
                        project_id: project_id,
            ...
            $(document).on('click', '#project_assign_save', function() {
                ...
                if(isSelectAllChecked == true) {
                    swal.fire({
                        text: "Do you want to generate touch count report?",
                        icon: "success",
                        ...
                        if (result.value == true) {
                            $.ajax({
                                type: "POST",
                                url: "{{ url('report/touch_report_client_columns_list') }}",
                                data: {
                                    project_id: project_id,
                                    sub_project_id: sub_project_id,
                                    work_date: work_date,
