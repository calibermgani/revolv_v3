                        ...
                        <div class="card card-custom custom-top-border">
                                        ...
                                        @foreach ($projectColSearchFields as $key => $data)
                                         ...
                                         $subProjectName = $data->sub_project_id != null ? App\Http\Helper\Admin\Helpers::encodeAndDecodeID($data->sub_project_id, 'encode') : '--';
                                            @endphp
                                             {!! Form::open([
                                                'url' =>
                                                url('qa_production/qa_projects_hold/' . $clientName . '/' . $subProjectName) .
                                                                '?parent=' .
                                                                request()->parent .
                                                                '&child=' .
                                                                request()->child,
                            ...
                            <div class="card-body py-0 px-7">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="ml-3">
                                        Showing {{ $holdProjectDetails->firstItem() != null ? $holdProjectDetails->firstItem() : 0 }} to {{ $holdProjectDetails->lastItem() != null ? $holdProjectDetails->lastItem() : 0 }} of {{ $holdProjectDetails->total() }} entries
                                    </div>
                                     <div>
                                        {{ $holdProjectDetails->appends(request()->all())->links() }}
                                    </div>
                                </div>
                            </div>
